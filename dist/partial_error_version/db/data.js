var data = {
	...
	activities: [
		...
		},
		{
			...
			code: [
				{ insert_after: "</h1>", snippet: "<div " },
				{ insert_after: "</p>", snippet: "</iv>" }
			]
		},
		{
			title: "Attributes",
			content:
				"<p>Attributes are content added to the opening tag of an element and can be used in several different ways, from providing information to changing styling. Attributes are made up of the following two parts:<ul><li>The name of the attribute</li><li>The value of the attribute</li></ul></p><p>One commonly used attribute is the id.</p><p>Complete the <<span>div></span> element by fixing the error in the value 'introduction' of the id attribute.</p>",
			hint: [
			...
			code: [{ insert_after: "<div", snippet: "id:'introduction'" }]
		},
		{
			title: "Headers",
			content:
				"<p>In HTML, there are six different headings, or heading elements. Headings can be used for a variety of purposes, like titling sections, articles, or other forms of content. The following is the list of heading elements available in HTML. They are ordered from largest to smallest in size. <ol><li><<span>h1></span> — used for main headings. All other smaller headings are used for subheadings.</li><li><<span>h2></span></li><li><<span>h3></span></li><li><<span>h4></span></li><li><<span>h5></span></li><li><<span>h6></span></li></ol></p><p>Complete the header below by fixing the error in the syntax and write your contact information.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
		...
		},
		{
			...
			code: [{ insert_after: "</h6>", snippet: "<p>Add Lorem Ipsum Text Here<p/>" }]
		},
		{
			title: "Span Containers",
			content:
				"<p>Span elements contains short pieces of text or other HTML. They are used to separate small pieces of content that are on the same line as other content.</p><p>Wrap the 'Lorem ipsum' text within a <<span>span></span> container by fixing the error in the syntax.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [
				{ insert_after: "<p>", snippet: "<spn>" },
				{ insert_after: "Lorem", snippet: "</spn>" }
			]
		},
		{
			title: "Div Containers",
			content:
				"<p>Div elements are very useful for grouping elements in your HTML together. These can contain any text or other HTML elements, such as links, images, or videos. Remember to always add four spaces of indentation when you nest elements inside of <<span>div>s</span> for better readability.</p><p>Complete the <<span>div></span> tag before the paragraph element by fixing the error in the syntax.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [
				{ insert_after: "</h6>", snippet: "<div>" },
				{ insert_after: "</p>", snippet: "<div>" }
			]
		},
		{
			title: "Emphasizing Elements",
			content: "<p>The <<span>em></span> tag will generally render as italic emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', emphasize 'Lorem' by fixing the error in the syntax to the <<span>em></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [
				{ insert_after: "<span>", snippet: "<em>" },
				{ insert_after: "Lorem", snippet: "<|em>" }
			]
		},
		{
			title: "Bolding Elements",
			content: "<p>The <<span>strong></span> will generally render as bold emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', bold 'Lorem' by fixing the error in the syntax to the <<span>/strong></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [
				{ insert_after: "<span>", snippet: "</strong>" },
				{ insert_after: "</em>", snippet: "</strong>" }
			]
		}
	],
	responses: []
