var data = {
	...
	activities: [
		...
		},
		{
			...
			content: "<p>The <<span>em></span> tag will generally render as italic emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', emphasize 'Lorem' using the <<span>em></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
		...
		},
		{
			...
			content: "<p>The <<span>strong></span> will generally render as bold emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', bold 'Lorem' using the <<span>strong></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
