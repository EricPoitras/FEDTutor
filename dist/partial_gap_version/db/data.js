var data = {
	...
	activities: [
		...
		},
		{
			...
			code: [{ insert_after: "<div", snippet: "id=''" }]
		},
		{
			title: "Headers",
			content:
				"<p>In HTML, there are six different headings, or heading elements. Headings can be used for a variety of purposes, like titling sections, articles, or other forms of content. The following is the list of heading elements available in HTML. They are ordered from largest to smallest in size. <ol><li><<span>h1></span> — used for main headings. All other smaller headings are used for subheadings.</li><li><<span>h2></span></li><li><<span>h3></span></li><li><<span>h4></span></li><li><<span>h5></span></li><li><<span>h6></span></li></ol></p><p>Complete the header below by adding the missing syntax and write your contact information.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
		...
		},
		{
			...
			code: [{ insert_after: "</h6>", snippet: "</p>" }]
		},
		{
			title: "Span Containers",
			content:
				"<p>Span elements contains short pieces of text or other HTML. They are used to separate small pieces of content that are on the same line as other content.</p><p>Wrap the 'Lorem ipsum' text within a <<span>span></span> container by adding the missing syntax.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
		...
		},
		{
			...
			code: [{ insert_after: "</h6>", snippet: "<div>" }]
		},
		{
			title: "Emphasizing Elements",
			content: "<p>The <<span>em></span> tag will generally render as italic emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', emphasize 'Lorem' by adding the missing syntax to the <<span>em></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [{ insert_after: "<span>", snippet: "<em>" }]
		},
		{
			title: "Bolding Elements",
			content: "<p>The <<span>strong></span> will generally render as bold emphasis.</p><p>In the first paragraph that starts 'Lorem ipsum', bold 'Lorem' by adding the missing syntax to the <<span>/strong></span> tag.</p>",
			hint: [
				{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" },
			...
			code: [{ insert_after: "</em>", snippet: "</strong>" }]
		}
	],
	responses: []
};
