	...
	activities: [
		{
			...
			reference: [{ id: "HTML Introduction", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_intro.asp' target='_blank'>What is HTML?</a>" }],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Basic", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_basic.asp' target='_blank'>What is the basic syntax in HTML?</a>" }],
			solution: [
			...
			hint: [
				{
					...
					id: "Solution #1",
					content:
						"<p>Try the following:</p><p><<span>div</span>><<span>p></span>Job Title<<span>/p></span><<span>/div</<span>></p>"
				}
			],
			reference: [
				{
					id: "HTML Elements",
					content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_elements.asp' target='_blank'>What are some example HTML elements??</a>"
				}
			],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Attributes", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_attributes.asp' target='_blank'>What are attributes?</a>" }],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Headings", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_headings.asp' target='_blank'>What are headers?</a>" }],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Paragraphs", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/html/html_paragraphs.asp' target='_blank'>What are parapgraphs?</a>" }],
			solution: [
				{ id: "Opening tag", criteria: "<p>" },
				{ id: "Closing tag", criteria: "</p>" }
			]
		...
		},
		{
			...
			reference: [{ id: "HTML Emphasis", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/tags/tag_em.asp' target='_blank'>How do we emphasize HTML?</a>" }],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Strong", content: "<hr><p>Here is a helpful link to the HTML reference material about this exercise:</p><a href='https://www.w3schools.com/tags/tag_strong.asp' target='_blank'>How to we bold HTML?</a>" }],
			solution: [
