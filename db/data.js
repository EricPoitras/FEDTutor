	...
	activities: [
		{
			...
			reference: [{ id: "HTML Introduction", content: "<a href='https://www.w3schools.com/html/html_intro.asp' target='_blank'>What is HTML?</a>" }],
			solution: [
		...
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Basic", content: "<a href='https://www.w3schools.com/html/html_basic.asp' target='_blank'>What is the basic syntax in HTML?</a>" }],
			solution: [
		...
		},
		{
			...
			reference: [
				{
					id: "HTML Elements",
					content: "<a href='https://www.w3schools.com/html/html_elements.asp' target='_blank'>What are some example HTML elements??</a>"
				}
			],
			solution: [
		...
		},
		{
			...
			reference: [{ id: "HTML Attributes", content: "<a href='https://www.w3schools.com/html/html_attributes.asp' target='_blank'>What are attributes?</a>" }],
			solution: [
		...
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Headings", content: "<a href='https://www.w3schools.com/html/html_headings.asp' target='_blank'>What are headers?</a>" }],
			solution: [
		...
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Paragraphs", content: "<a href='https://www.w3schools.com/html/html_paragraphs.asp' target='_blank'>What are parapgraphs?</a>" }],
			solution: [
				{ id: "Opening tag", criteria: "<p>" },
				{ id: "Closing tag", criteria: "</p>" }
			]
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Span", content: "<a href='https://www.w3schools.com/tags/tag_span.asp' target='_blank'>What is a span?</a>" }],
			solution: [
		...
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Div", content: "<a href='https://www.w3schools.com/tags/tag_div.asp' target='_blank'>What is a div?</a>" }],
			solution: [
				{ id: "Opening tag", criteria: "<div>" },
				{ id: "Closing tag", criteria: "</div>" }
			]
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Emphasis", content: "<a href='https://www.w3schools.com/tags/tag_em.asp' target='_blank'>How do we emphasize HTML?</a>" }],
			solution: [
		...
		},
		{
			...
			hint: [{ id: "Hint #1", content: "<p>Try the following:</p><p><<span>element</span>>text content<<span>/element</span>></p>" }],
			reference: [{ id: "HTML Strong", content: "<a href='https://www.w3schools.com/tags/tag_strong.asp' target='_blank'>How to we bold HTML?</a>" }],
			solution: [
